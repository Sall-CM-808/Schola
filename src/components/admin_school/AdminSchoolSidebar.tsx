...
interface AdminSchoolSidebarProps {
  isCollapsed: boolean;
  onToggle: () => void;
}

const base = "/admin_school";
const items: SidebarItem[] = [
  {
    id: "establishments",
    label: "Établissements",
    href: `${base}/establishments`,
...
const AdminSchoolSidebar: React.FC<AdminSchoolSidebarProps> = ({
  isCollapsed,
  onToggle,
}) => {
          ...
          {!isCollapsed && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-white/60">Structure (copie)</p>
              </div>
            </motion.div>
          )}
          <button
...
export default AdminSchoolSidebar;
